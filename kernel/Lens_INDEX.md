...
| **Lens** *(governance)* | `Lens_governance_session_summary_GO_KANON_TOCHKOVO.md` · `Lens_governance_session_summary_GN_ROZPYL_S6.md` *(GM витіснено 18.09.2026 сесією G-P; GL — G-O; GK — G-N; GJ — G-M; GI — G-L; GH — G-K; GG — G-J; GF — G-H; GA…GE — 17.09.2026 → `archive/summaries/Lens_gov/`)* |
